        ...
        <div className="relative bg-black">
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pt-10">
                ...
                <div className="flex items-center md:justify-center">
                    ...
                    >
                        <button type="button" className="text-white bg-gradient-to-br from-yellow-300 to-pink-600 hover:bg-gradient-to-bl focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Get my CV</button>
                    </Link>
                </div>
            </div>
        </div>
